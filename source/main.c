...
int _main(void)
{
   ...
   char data[10] = {0x00, 0x00, 0x00, 0x00, 0x00, 60, 0x00, 0x00, 0x00, 0x00}; //char *data[11] = {0x00, 0x00, 0x00, 0x00, 0x00, 60, 0x00, 0x00, 0x00, 0x00, 0x08}; // swap 60 with whatever temp threshold you want, 0x08 may be unnecessary
